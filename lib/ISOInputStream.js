...
class ISOInputStream {
    ...
    read(arr, start = 0, count) {
        ...
        ISOUtil_js_1.default.arraycopy(_bs, _p, arr, start, count);
        this._p += count;
    }
    /**
    ...
    readBCD_c(len) {
        ...
        let res = '';
        const CA = ISOUtil_js_1.default.CA;
        len /= 2;
        for (let i = 0; i < len; i++) {
            let v = this.readByte();
            res += CA[v >> 4];
...
exports.default = ISOInputStream;
//# sourceMappingURL=ISOInputStream.js.map